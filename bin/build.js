...
await Promise.all([
    compile({
        ...defaultOptions,
        entryPoints: ['./resources/js/phpicker.js'],
        outfile: './resources/dist/phpicker.js',
    }),
    compile({
        ...defaultOptions,
        entryPoints: ['./resources/js/calendar.js'],
        outfile: './resources/dist/calendar.js',
    }),
    compile({
        ...defaultOptions,
        entryPoints: ['./resources/js/cron-expression.js'],
        outfile: './resources/dist/cron-expression.js',
    }),
    compile({
        ...defaultOptions,
    ...
    compile({
        ...
        outfile: './resources/dist/calendar.css',
    }),
])
